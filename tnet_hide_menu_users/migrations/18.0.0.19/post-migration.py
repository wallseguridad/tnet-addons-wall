# Post-migration 18.0.0.19: poblar business_cost / business_cost_currency_id /
...
def migrate(cr, version):
    ...
    if cr.fetchone()[0]:
        ...
        print(f"[wall 18.0.0.19] business_cost_currency_id ← property_currency_id: {migrated} productos")
